...
// ✅ ВИПРАВЛЕННЯ: overlay зупиняє спливання кліку до арени
// Без цього клік на кнопку СТАРТ: startGame() → overlay ховається →
// клік спливає до #arena → handleMiss() → overlay знову з'являється
